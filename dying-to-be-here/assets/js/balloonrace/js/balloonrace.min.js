var google_docs_url_root = "https://docs.google.com/spreadsheet/pub?key=", config_csv_url = "&single=true&gid=1&range=B1%3AD100&output=csv", data_csv_url = "&single=true&gid=2&range=A1%3AT500&output=csv", data_webpage_url = "&single=true&gid=2&range=A2%3AL300&output=html", sheet_url, font_name, font_weight, offline_mode, stage_size = [], dimensions_obj = {}, device_type, config_JSON_arr, data_JSON_arr, PJS_instance, facet_ids = {}, enabled_value = "Yes", disabled_value = "No", processing_notification_text, datapoints_arr = [], minimum_radius, maximum_radius, shuffle_duration_limit, instruction_text = "Roll over a bubble for more detail.", scale_obj, scaleLabels_arr = [], dividinglines_arr = [], horizontal_buffer_amount = 40, vertical_buffer_amount = 30, scale_font_size = 11, filter_categories_arr = [], filter_types_arr = [], bubble_size_params_arr = [], show_filter_button, context = "", axis_context, bubble_colours_arr = [], bubble_linear_gradient, bubble_one_to_watch_fill, preset_gradient_set, gradient_set_direction, type_colours_arr, bubble_colours_params_arr = [], colour_bubbles_by, reordering_params_arr = [], type_colour_palettes = [{
  id: "Grayscale",
...
}], user_defined_palette, functionality_obj = {
  app_status: "LOADING"
}, active_data_point, mouse_y, bubble_size_param_name, mousetrap_obj = {};
$(document).ready(function() {
  ...
  if (offline_mode) {
    ...
    a.appendChild(document.createTextNode("\t\t@font-face {\t\tfont-family: '" + font_name + "';\t\tsrc: local('\u263a'), url('user-editable/" + font_name + "-" + font_weight + ".ttf');\t\t}\t\t"));
    document.head.appendChild(a);
    $("body").css("font-family", font_name + ', "Dosis"')
  } else {
    WebFontConfig = {
      google: {
        families: [font_name + ":" + font_weight + ":latin", "Dosis:Medium:latin"]
      }
    };
...
function getQueryStringVars() {
  ...
  dimensions_obj.desktop = [parseInt(getParameterByName("desktop_width")), parseInt(getParameterByName("desktop_height"))];
  dimensions_obj.tablet = [parseInt(getParameterByName("tablet_width")), parseInt(getParameterByName("tablet_height"))];
  dimensions_obj.mobile = [parseInt(getParameterByName("mobile_width")), parseInt(getParameterByName("mobile_height"))];
...
function setNotifications(a) {
  "LOADING" == a ? ($("#nojs-notification").css("display", "none"),
  $("#loading-notification").css("display", "block")) : "NOJS" == a ? ($("#notifications-container").css("display", "block"),
  $("#nojs-notification").css("display", "block"),
  $("#loading-notification").css("display", "none")) : "NONE" == a && $("#notifications-container").css("display", "none")
}
...
function onConfigJSONLoaded(a) {
  config_JSON_arr = a;
  config_JSON_arr.error ? $("#loading-notification").text("This visualisation is not authorised. Please contact XXX") : loadDataJSONOnline()
}
...
function checkPJSLoad() {
  function a() {
    ...
    null == PJS_instance ? setTimeout(a, 250) : (dbg("found : " + PJS_instance),
...
function setDimensions() {
  ...
  var d = $("#info-popup")
    ...
    , g = $("#viz-filter-panel");
  "is_mobile" == device_type ? (dbg("assuming mobile"),
  ...
  d.css("margin-top", 40),
  shuffle_duration_limit = 400) : "is_tablet" == device_type ? (dbg("assuming tablet"),
  ...
  for (var b = 0; b < config_JSON_arr.length; b++)
    ...
    case "line":
      var c = ""
        , d = ""
        , e = a.firstvalue;
      "" != a.secondvalue && (-1 == a.secondvalue.indexOf(",") ? c = a.secondvalue : (a = String(a.secondvalue).split(","),
      c = a[0],
      d = trimTrailingSpaces(a[1])));
      "" != e && "" != c && (a = new PJS_instance.DividingLine(e,c,d),
      a.getPosition(),
    ...
    case "entitycolourset":
      ...
      for (c = 0; c < type_colour_palettes.length; c++)
        a == type_colour_palettes[c].id && (type_colours_arr = type_colour_palettes[c].colours_arr);
      break;
    case "typecolour":
      a.firstvalue && (user_defined_palette || (user_defined_palette = []),
      user_defined_palette && user_defined_palette.push({
        id: a.firstvalue,
        bubble_colour: a.secondvalue
      }));
      break;
    case "gradientcolourset":
      "None" != a.firstvalue && (preset_gradient_set = a.firstvalue,
      gradient_set_direction = a.secondvalue);
      break;
    case "gradientcolour":
      null == preset_gradient_set && bubble_colours_arr.push({
    ...
    case "onetowatchcolour":
      ...
      $("#one-to-watch-circle").css("background-color", bubble_one_to_watch_fill);
    ...
    case "func_allow_reordering":
      a.firstvalue == enabled_value ? reordering_params_arr = [{
        id: "name",
        type: "string",
        direction: "ascending",
        checked: !0
    ...
    case "func_filter_metric_001":
      ...
      a.firstvalue == enabled_value && bubble_size_params_arr.push({
        id: "metric_001",
        checked: checked
      });
      break;
    ...
    case "func_xaxis_metric_001":
      dbg("checking : func_xaxis_metric_001 " + isMetricEnabled("metric_001"));
      a.firstvalue == enabled_value && reordering_params_arr.push({
        id: "metric_001",
        checked: !1,
        type: "number",
        direction: "ascending"
    ...
    case "processingnotification":
      ...
      break;
    case "disclaimer":
      "" != a.secondvalue ? (c = $("#info-popup"),
      $("#info-popup-title").text(a.firstvalue),
      c.css("display", "block"),
      a = a.secondvalue,
      $("#info-popup-content").html(a)) : setTimeout(closeDisclaimer, 1500);
      break;
    ...
    case "source":
      ...
      break;
    case "seethedatalink":
      "" != a.firstvalue ? $("#see-the-data-button a").attr("href", a.firstvalue) : $("#see-the-data-button").css("display", "none");
      break;
    case "sendfeedbacklink":
      $("#send-feedback-button a").attr("href", a.firstvalue).css("visibility", "visible");
      break;
    case "footerlogo_001":
      a.firstvalue && (c = $("#footer-logo-001"),
      c.css("visibility", "visible"),
      c.find("img").attr("src", a.firstvalue),
      a.secondvalue && c.children("a").attr("href", a.secondvalue));
      break;
    case "footerlogo_002":
      a.firstvalue && (c = $("#footer-logo-002"),
      c.css("visibility", "visible"),
      c.find("img").attr("src", a.firstvalue),
      a.secondvalue && c.children("a").attr("href", a.secondvalue));
      break;
    case "footerlogo_003":
      a.firstvalue && (c = $("#footer-logo-003"),
      c.css("visibility", "visible"),
      c.find("img").attr("src", a.firstvalue),
      a.secondvalue && c.children("a").attr("href", a.secondvalue))
    }
...
function isMetricEnabled(a) {
  for (var b = 0; b < bubble_size_params_arr.length; b++)
    if (bubble_size_params_arr[b].id == a)
      return !0;
  return !1
}
function passJSONDataToPJSInstance() {
  ...
  for (var g = 0; g < data_JSON_arr.length; g++)
    a = data_JSON_arr[g],
    "" == a.exclude && (a.metric_001 = "" != a.metric_001 ? parseFloat(a.metric_001) : 0,
  ...
  for (g = 0; g < data_JSON_arr.length; g++)
    a = data_JSON_arr[g],
    "" == a.exclude && (b = splitStringToArrayAndTrimSpaces(a.subcategory),
    c = splitStringToArrayAndTrimSpaces(a.category),
    d = splitStringToArrayAndTrimSpaces(a.type),
    "" != a.thirdsource ? f = a.thirdsource : "" != a.secondsource ? f = a.secondsource : "" != a.firstsource && (f = a.firstsource),
    e = functionality_obj.onetowatch ? a.highlight : !1,
    b = new PJS_instance.DataPoint(a.name,a.alternativename,a.primaryvalue,b,c,d,e,a.metric_001,a.metric_002,a.metric_003,a.metric_004,a.notes,a.exclude,f,g),
  ...
  datapoints_arr = sortArrayBy(datapoints_arr, "_name", "string", "ascending", !0);
  buildFilterPanel();
...
function checkMetricContent(a) {
  ...
  if (!c) {
    for (d = 0; d < bubble_size_params_arr.length; d++)
      bubble_size_params_arr[d].id == "metric_" + a && bubble_size_params_arr.splice(d, 1);
    for (d = 0; d < reordering_params_arr.length; d++)
      reordering_params_arr[d].id == "metric_" + a && reordering_params_arr.splice(d, 1)
  }
}
function extractFacetNames() {
  ...
  a = [data_JSON_arr[0].metric_001, data_JSON_arr[0].metric_002, data_JSON_arr[0].metric_003, data_JSON_arr[0].metric_004];
...
function makeBackgroundGradient() {
  if (null != preset_gradient_set) {
    var a, b = scale_obj._minimum + (scale_obj._maximum - scale_obj._minimum) / 2, c;
    "Top to Bottom" == gradient_set_direction ? (a = scale_obj._maximum,
    c = scale_obj._minimum) : (a = scale_obj._minimum,
    c = scale_obj._maximum);
...
function checkTextColourForHexValue(a) {
  ...
  a = [parseInt(b(a).substring(0, 2), 16), parseInt(b(a).substring(2, 4), 16), parseInt(b(a).substring(4, 6), 16)];
  return text_colour = 100 > (a[0] + a[1] + a[2]) / 3 ? "white" : "black"
}
function addUnparsedItemToArray(a, b) {
  if (-1 == b.indexOf(","))
    addParsedItemToArray(a, b);
  else
...
function addParsedItemToArray(a, b) {
  if ("" != b) {
    ...
    !1 == c && (c = a.length < type_colours_arr.length ? type_colours_arr[a.length] : getRandomGrey(),
...
function byte2Hex(a) {
  return String("0123456789ABCDEF".substr(a >> 4 & 15, 1)) + "0123456789ABCDEF".substr(a & 15, 1)
}
function buildFilterPanel() {
  ...
  if (user_defined_palette)
    for (var a, b = 0; b < user_defined_palette.length; b++) {
      ...
      for (var c = 0; c < filter_types_arr.length; c++)
        filter_types_arr[c].id == a.id && (filter_types_arr[c].bubble_colour = a.bubble_colour)
    }
  ...
  650 < stage_size[0] && "is_mobile" != device_type && ($("#category-filters-container").css("float", "left"),
  ...
  stage_size[0] - 220 < a.width() ? a.width(stage_size[0]) : a.width(stage_size[0] - 220);
  onFilterCheckboxInteraction()
}
function moveOtherToEnd(a) {
  for (var b = -1, c, d = 0; d < a.length; d++)
    if (c = a[d],
    "other" == c.id || "Other" == c.id) {
      b = d;
      break
    }
  -1 != b && (b = a.splice(b, 1)[0],
  a.push(b));
  return a
}
function addFilterCheckBoxes(a, b) {
  for (var c = "", d, e, f, g, h = 0; h < b.length; h++)
    ...
    c += '<label class="filter-checkbox-label" for="' + e + '">' + g + '<input type="checkbox" name="' + h + '" id="' + e + '" value = ' + d + f + ' group="' + a + '"/>' + d + "</label>";
  $("#" + a + "-filters").html(c);
...
function onColourButtonClick() {
  for (var a, b = 0; b < bubble_colours_params_arr.length; b++)
    if (a = bubble_colours_params_arr[b],
    a.button_id_str == this.id) {
      a.checked = !0;
...
function showHighlightKey() {
  var a;
  a = "always" == functionality_obj.onetowatch ? "block" : "primary_value_only" == functionality_obj.onetowatch && "value" == colour_bubbles_by ? "block" : "type_only" == functionality_obj.onetowatch && "type" == colour_bubbles_by ? "block" : "none";
...
function onShowFilterButtonClick() {
  ...
  setHeaderButtonState(this, show_filter_button.checked);
  !0 == show_filter_button.checked ? ($("#filter-show-button-label").html('<img src="i/balloon_race_icon_filter_8px.png"/>HIDE FILTER'),
  a.css("display", "block")) : ($("#filter-show-button-label").html('<img src="i/balloon_race_icon_filter_8px.png"/>SHOW FILTER'),
  a.css("display", "none"))
}
function setHeaderButtonState(a, b) {
  b ? ($(a).css("background-color", "grey"),
  $(a).css("color", "white")) : ($(a).css("background-color", "white"),
  $(a).css("color", "black"))
}
function showFilter() {
  dbg("showing filter : ");
...
function onOrderinguttonClick() {
  for (var a, b = 0; b < reordering_params_arr.length; b++)
    if (a = reordering_params_arr[b],
    a.button_id_str == this.id) {
      a.checked = !0;
      setHeaderButtonState(this, a.checked);
      datapoints_arr = sortArrayBy(datapoints_arr, "_" + a.id, a.type, a.direction, !0);
...
function onFilterCheckboxInteraction(a) {
  ...
  a && (a = filter_categories_arr[a.currentTarget.name].id,
...
function setCorrectFilterCheckboxes(a, b) {
  for (var c = $("form#" + a + "-filters input"), d = c[0].checked && !b[0].checked ? !0 : !1, e = !1, f = 1; f < c.length; f++)
    if (d)
      c[f].checked = !1;
    else if (c[f].checked) {
      e = !0;
...
function checkFakeCheckbox(a, b, c) {
  var d, e;
  "value" == colour_bubbles_by || "category" == a ? d = {
    "background-image": "url( i/br_tick_" + c + ".png )",
    "background-color": "inherit",
    border: "none"
  } : (e = filter_types_arr[b].bubble_colour ? filter_types_arr[b].bubble_colour : "808080",
  d = {
    "background-image": "none",
    border: "2px solid #" + e
  },
  d["background-color"] = filter_types_arr[0].checked && "type" == colour_bubbles_by || "on" == c ? "#" + e : "inherit");
  $("#" + a + "_" + b + "-graphic").css(d)
}
...
function checkActiveFiltersAgainstDataPoints() {
  for (var a, b, c, d = 0; d < datapoints_arr.length; d++)
    a = datapoints_arr[d],
    (b = checkActiveFilterType(filter_categories_arr, a._categories_arr)) && (c = checkActiveFilterType(filter_types_arr, a._types_arr)),
...
function sortArrayBy(a, b, c, d, e) {
  ...
  function h(a, c) {
    return parseFloat(a[b]) > parseFloat(c[b]) ? -1 : parseFloat(a[b]) < parseFloat(c[b]) ? 1 : 0
  }
  function k(a, c) {
    return parseFloat(a[b]) < parseFloat(c[b]) ? -1 : parseFloat(a[b]) > parseFloat(c[b]) ? 1 : 0
  }
  a = "string" == c ? "descending" == d ? a.sort(f) : a.sort(g) : "descending" == d ? a.sort(h) : a.sort(k);
  if (e)
...
function splitStringToArrayAndTrimSpaces(a) {
  if (-1 != a.indexOf(",")) {
    ...
    for (var b, c = 0; c < a.length; c++)
      b = a[c],
      -1 != b.indexOf(" ") && (a[c] = trimTrailingSpaces(b))
  } else
    a = [a];
  return a
}
...
function ScaleLabel(a, b) {
  ...
  this.getPosition = function() {
    ...
    x = 0;
    y = stage_size[1] - vertical_buffer_amount - (a - scale_obj._minimum) / (scale_obj._maximum - scale_obj._minimum) * (stage_size[1] - 2 * vertical_buffer_amount);
    c()
  }
  ;
...
function drawDottedLine(a, b, c, d, e, f) {
  ...
  for (d = 0; d < c; d++)
    a += g,
    b += h,
    drawDottedLineElement(a, b, 1, e, f)
}
...
function checkMousePosition(a) {
  ...
  for (var c, d, e, f, g = datapoints_arr.length - 1; 0 <= g; g--)
    ...
    e -= b,
    f -= a,
    Math.sqrt(e * e + f * f) < d ? active_data_point || (active_data_point = c,
    c.mouseOver(),
    datapoints_arr.splice(datapoints_arr.indexOf(c), 1),
    datapoints_arr.push(c)) : (active_data_point == c && (active_data_point = null,
    datapoints_arr = sortArrayBy(datapoints_arr, "_" + bubble_size_param_name, "number", "descending", !1)),
    c.mouseOut())
}
